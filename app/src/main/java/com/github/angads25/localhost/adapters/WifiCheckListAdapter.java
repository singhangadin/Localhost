...
import com.github.angads25.localhost.models.SortListItem;
...
public class WifiCheckListAdapter extends RecyclerView.Adapter<WifiCheckListAdapter.WifiListHolder>
    implements CompoundButton.OnCheckedChangeListener {
    private ArrayList<SortListItem> scanList;
    private Context context;

    public WifiCheckListAdapter(ArrayList<SortListItem> scanList, Context context) {
